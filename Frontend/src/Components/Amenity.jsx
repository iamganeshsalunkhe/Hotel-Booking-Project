    ...
    async function addAmenity(){
        if (currentAmenity.name && currentAmenity.price){
            try {
                ...
                const response = await axios.post('http://localhost:4100/amenities',currentAmenity);
            ...
            <div className="p-5 text-center bg-slate-400 h-[550px]">
                <h1 className="text-3xl font-bold">Add an amenity</h1>
                    <div className="mt-5 grid grid-cols-2 gap-8 ">
                        ...
                        <div className="col-span-1">
                            <label htmlFor='input2' className="block font-bold text-black">Description</label>
                            <input 
                            id="input2"
                            name="description"
                            type="text"
                        ...
                        <div className="col-span-1">
                            <label htmlFor='input3' className="block font-bold text-black">Price</label>
                            <input 
                            id="input3"
                            name="price"
                            type="number"
